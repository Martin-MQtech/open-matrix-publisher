...
description: Open Matrix Publisher (全域矩阵) 智能体发布技能。支持 28 大国内与海外主流视频与社交媒体平台（视频号、抖音、B站、小红书、快手、百家号、番茄、YouTube、TikTok、Instagram、Facebook、X、LinkedIn、Pinterest、Reddit 等）一键静默并发发布与账号状态检测。
---

# Open Matrix Publisher 智能体分发技能

本技能为智能体（Google Antigravity、DeepSeek Harness、Hermes Agent、Zed、Claude Code、Cursor）提供全网 28 平台多渠道并发分发与状态查询能力。

## 核心能力
- **`publish_video`**：将本地或远程 HTTP/HTTPS 直链视频批量推送到指定的国内与海外平台矩阵。
- **`check_account_status`**：检查各平台的登录 Cookie 与账号授权有效性。
- **`list_supported_platforms`**：获取 28 大平台列表与配置。
